<form method="post">
  ...
  <input type="text" name="cidade_estado"><br>
  ...
  <label for="">DADOS ACADEMICOS</label><br>
  ...
  <input type="radio" id="manha" name="gender" value="manha">
  <label for="">Manha</label><br>
  <input type="radio" id="tarde" name="gender" value="tarde">
  <label for="">Tarde</label><br>
  <input type="radio" id="noite" name="gender" value="noite">
